...
log_dir = os.path.join(path, "rnet", "msmarco", "local_span_with_high_dim", "log", "event")
save_dir = os.path.join(path, "rnet", "msmarco", "local_span_with_high_dim", "log", "model")
save_dir_temp = os.path.join(path, "rnet", "msmarco", "local_span_with_high_dim", "log", "model")
answer_dir = os.path.join(path, "rnet", "msmarco", "local_span_with_high_dim", "log", "answer")
