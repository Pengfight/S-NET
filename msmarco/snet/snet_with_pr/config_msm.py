...
#target_dir = "data"
target_dir = os.path.join(path, "preprocess", "snet", "msmarco", "pr")
log_dir = os.path.join(path, "snet", "snet_without_pr", "log", "event")
save_dir = os.path.join(path, "snet", "snet_without_pr", "log", "model")
save_dir_temp = os.path.join(path, "snet", "snet_without_pr", "log", "model")
answer_dir = os.path.join(path, "snet", "snet_without_pr", "log", "answer")
...
flags.DEFINE_string("save_dir_temp", save_dir_temp, "Directory for saving model")
...
flags.DEFINE_integer("batch_size", 4, "Batch size") # 64
